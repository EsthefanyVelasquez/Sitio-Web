...
// Función para manejar el clic en los rectángulos
function handleClick() {
  // Esta función no realizará ninguna acción específica
  console.log("Rectángulo clicado");
}

// Seleccionar los primeros 10 rectángulos y agregarles el evento de clic
for (let i = 1; i <= 10; i++) {
  const rectangulo = document.querySelector(`.rectangulo-${i}`);
