...
document.addEventListener("DOMContentLoaded", function() {
  ...
  rejectCookiesBtn.addEventListener("click", function() {
      ...
      cookieConsent.style.display = "none";
      // Aquí puedes añadir más acciones, como bloquear ciertas funcionalidades que requieren cookies.
  });

  // Mostrar el componente de consentimiento de cookies cada vez que se actualiza la página
